...
public class TurnoJpaController implements Serializable {
    ...
    public void create(Turno turno) {
        ...
        try {
            ...
            if (odontologo != null) {
                odontologo
                        = em.getReference(odontologo.getClass(),
                        odontologo.getId());
            ...
            if (paciente != null) {
                paciente
                        = em.getReference(paciente.getClass(), paciente.getId());
    ...
    public void edit(Turno turno) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (odontologoNew != null) {
                odontologoNew
                        = em.getReference(odontologoNew.getClass(),
                        odontologoNew.getId());
                turno.setOdontologo(odontologoNew);
            }
            if (pacienteNew != null) {
                pacienteNew
                        = em.getReference(pacienteNew.getClass(),
                        pacienteNew.getId());
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findTurno(id) == null) {
                    throw new NonexistentEntityException("The turno with id " +
                            id + " no longer exists.");
                }
            }
            throw ex;
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The turno with id " + id +
    ...
    private List<Turno> findTurnoEntities(boolean all, int maxResults,
            int firstResult) {
