...
public class HorarioJpaController implements Serializable {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findHorario(id) == null) {
                    throw new NonexistentEntityException("The horario with id " +
                            id + " no longer exists.");
                }
            }
            throw ex;
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("The horario with id " + id +
    ...
    private List<Horario> findHorarioEntities(boolean all, int maxResults,
            int firstResult) {
