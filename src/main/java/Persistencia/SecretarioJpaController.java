...
public class SecretarioJpaController implements Serializable {
    ...
    public void edit(Secretario secretario) throws NonexistentEntityException,
            Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findSecretario(id) == null) {
                    throw new NonexistentEntityException("The secretario with id " +
                            id + " no longer exists.");
                }
            }
            throw ex;
    ...
    public List<Secretario> findSecretarioEntities(int maxResults,
            int firstResult) {
        return findSecretarioEntities(false, maxResults, firstResult);
    }

    private List<Secretario> findSecretarioEntities(boolean all, int maxResults,
            int firstResult) {
